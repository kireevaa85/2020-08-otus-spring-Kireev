package ru.otus.mongock.testchangelog;
...
public class InitMongoDBDataChangeLog {
    ...
    @ChangeSet(order = "000", id = "dropDb", author = "Andrey.Kireev", runAlways = true)
    public void dropDb(MongoDatabase db) {
        db.drop();
    }

    @ChangeSet(order = "001", id = "initAuthors", author = "Andrey.Kireev", runAlways = true)
    ...
    @ChangeSet(order = "002", id = "initGenres", author = "Andrey.Kireev", runAlways = true)
    ...
    @ChangeSet(order = "003", id = "initBooks", author = "Andrey.Kireev", runAlways = true)
    ...
    @ChangeSet(order = "004", id = "initComments", author = "Andrey.Kireev", runAlways = true)
